...
billy = User.create(name: "billy", password: "awesome", password_confirmation: "awesome", first_name: "billy", last_name: "dale")
shun = User.create(name: "shun", password: "awesome", password_confirmation: "awesome", first_name: "shun", last_name: "yao")
gui = User.create(name: "gui", password: "awesome", password_confirmation: "awesome", first_name: "gui", last_name: "zhang")
yong = User.create(name: "yong-nicholas", password: "awesome", password_confirmation: "awesome", first_name: "YN", last_name: "kim")

...
Booking.create(performance_id: 23, schedule_id: 3)
Booking.create(performance_id: 16, schedule_id: 3)
Booking.create(performance_id: 4, schedule_id: 3)
Booking.create(performance_id: 10, schedule_id: 4)
Booking.create(performance_id: 5, schedule_id: 4)
Booking.create(performance_id: 18, schedule_id: 4)

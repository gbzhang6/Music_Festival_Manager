...
Performance.create(artist: Artist.find(15), stage: Stage.find(3), start_time: "14:30", end_time: "15:15")
Performance.create(artist: Artist.find(16), stage: Stage.find(3), start_time: "15:25", end_time: "16:00")
Performance.create(artist: Artist.find(17), stage: Stage.find(3), start_time: "16:45", end_time: "18:00")
Performance.create(artist: Artist.find(18), stage: Stage.find(3), start_time: "18:15", end_time: "23:00")
Performance.create(artist: Artist.find(19), stage: Stage.find(3), start_time: "18:15", end_time: "23:00")
Performance.create(artist: Artist.find(20), stage: Stage.find(4), start_time: "12:45", end_time: "13:30")
Performance.create(artist: Artist.find(21), stage: Stage.find(4), start_time: "14:15", end_time: "15:00")
Performance.create(artist: Artist.find(22), stage: Stage.find(4), start_time: "15:45", end_time: "16:30")
Performance.create(artist: Artist.find(23), stage: Stage.find(4), start_time: "18:00", end_time: "18:45")
Performance.create(artist: Artist.find(19), stage: Stage.find(4), start_time: "20:00", end_time: "21:15")

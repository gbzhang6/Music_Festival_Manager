class BookingsController < ApplicationController
  ...
  def create
    @booking = Booking.new(performance_id: params[:performance_id], schedule_id: params[:schedule_id])
  ...
  def find_friend
    ...
    if User.all_names.include?(params[:friend_name])
      @friend_user = User.find_by(username: params[:friend_name])
  ...
  def booking_params
    params.permit(:performance_id, :schedule_id)
  end
end
